      ...
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href="/login"><button class="submit" type="submit">Login</button></a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="services container">
      ...
      <div class="service-bottom">
        <div class="service-item">
          ...
          <h2>Peminjaman</h2>
          <p>deskrpsi:Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad, iusto cupiditate voluptatum impedit unde
        ...
        <div class="service-item">
          ...
          <h2>Penyimpanan</h2>
          <p>deskripsi:Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad, iusto cupiditate voluptatum impedit unde
                rem ipsa distinctio illum quae mollitia ut, accusantium eius odio ducimus illo neque atque libero non sunt
                harum? Ipsum repellat animi, fugit architecto voluptatum odit et!</p>
          </a>
        </div>
